...
export type NLNonprofitType = 'schema:NonprofitANBI' | 'schema:NonprofitSBBI';
export const NLNonprofitTypeSchema = z.union([z.literal('schema:NonprofitANBI'), z.literal('schema:NonprofitSBBI')]);
...
export const NerveSchema: z.ZodType<Nerve> = z.lazy(() => z.object({
  ...
  sensoryUnit: z.union([z.union([s.AnatomicalStructureSchema, s.SuperficialAnatomySchema]), z.array(z.union([s.AnatomicalStructureSchema, s.SuperficialAnatomySchema]))]).optional(),
  sourcedFrom: z.union([s.BrainStructureSchema, z.array(s.BrainStructureSchema)]).optional(),
...
export const NewsMediaOrganizationSchema: z.ZodType<NewsMediaOrganization> = z.lazy(() => z.object({
  ...
  diversityStaffingReport: z.union([z.union([s.ArticleSchema, z.string().url()]), z.array(z.union([s.ArticleSchema, z.string().url()]))]).optional(),
  ethicsPolicy: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  masthead: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  missionCoveragePrioritiesPolicy: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  noBylinesPolicy: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  ownershipFundingInfo: z.union([z.union([s.AboutPageSchema, s.CreativeWorkSchema, z.string(), z.string().url()]), z.array(z.union([s.AboutPageSchema, s.CreativeWorkSchema, z.string(), z.string().url()]))]).optional(),
  unnamedSourcesPolicy: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  verificationFactCheckingPolicy: z.union([z.union([s.CreativeWorkSchema, z.string().url()]), z.array(z.union([s.CreativeWorkSchema, z.string().url()]))]).optional(),
  acceptedPaymentMethod: z.union([z.union([s.LoanOrCreditSchema, s.PaymentMethodSchema, z.string()]), z.array(z.union([s.LoanOrCreditSchema, s.PaymentMethodSchema, z.string()]))]).optional(),
  address: z.union([z.union([s.PostalAddressSchema, z.string()]), z.array(z.union([s.PostalAddressSchema, z.string()]))]).optional(),
  agentInteractionStatistic: z.union([s.InteractionCounterSchema, z.array(s.InteractionCounterSchema)]).optional(),
  aggregateRating: z.union([s.AggregateRatingSchema, z.array(s.AggregateRatingSchema)]).optional(),
...
export const NutritionInformationSchema: z.ZodType<NutritionInformation> = z.lazy(() => z.object({
  ...
  cholesterolContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  fatContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  fiberContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  proteinContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  saturatedFatContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  servingSize: z.union([z.string(), z.array(z.string())]).optional(),
  sodiumContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  sugarContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  transFatContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  unsaturatedFatContent: z.union([s.MassSchema, z.array(s.MassSchema)]).optional(),
  additionalType: z.union([z.union([z.string(), z.string().url()]), z.array(z.union([z.string(), z.string().url()]))]).optional(),
  alternateName: z.union([z.string(), z.array(z.string())]).optional(),
  description: z.union([z.union([z.string(), s.TextObjectSchema]), z.array(z.union([z.string(), s.TextObjectSchema]))]).optional(),
  disambiguatingDescription: z.union([z.string(), z.array(z.string())]).optional(),
