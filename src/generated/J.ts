...
export const JobPostingSchema: z.ZodType<JobPosting> = z.lazy(() => z.object({
  ...
  directApply: z.union([z.boolean(), z.array(z.boolean())]).optional(),
  ...
  eligibilityToWorkRequirement: z.union([z.string(), z.array(z.string())]).optional(),
  employerOverview: z.union([z.string(), z.array(z.string())]).optional(),
  employmentType: z.union([z.string(), z.array(z.string())]).optional(),
  employmentUnit: z.union([s.OrganizationSchema, z.array(s.OrganizationSchema)]).optional(),
  ...
  experienceInPlaceOfEducation: z.union([z.boolean(), z.array(z.boolean())]).optional(),
  ...
  hiringOrganization: z.union([z.union([s.OrganizationSchema, s.PersonSchema]), z.array(z.union([s.OrganizationSchema, s.PersonSchema]))]).optional(),
  incentiveCompensation: z.union([z.string(), z.array(z.string())]).optional(),
  incentives: z.union([z.string(), z.array(z.string())]).optional(),
  industry: z.union([z.union([s.DefinedTermSchema, z.string()]), z.array(z.union([s.DefinedTermSchema, z.string()]))]).optional(),
  jobBenefits: z.union([z.string(), z.array(z.string())]).optional(),
  jobDuration: z.union([z.union([s.DurationSchema, s.QuantitativeValueSchema]), z.array(z.union([s.DurationSchema, s.QuantitativeValueSchema]))]).optional(),
  jobImmediateStart: z.union([z.boolean(), z.array(z.boolean())]).optional(),
  jobLocation: z.union([s.PlaceSchema, z.array(s.PlaceSchema)]).optional(),
  jobLocationType: z.union([z.string(), z.array(z.string())]).optional(),
  jobStartDate: z.union([z.string(), z.array(z.string())]).optional(),
  ...
  physicalRequirement: z.union([z.union([s.DefinedTermSchema, z.string(), z.string().url()]), z.array(z.union([s.DefinedTermSchema, z.string(), z.string().url()]))]).optional(),
  qualifications: z.union([z.union([s.CredentialSchema, z.string()]), z.array(z.union([s.CredentialSchema, z.string()]))]).optional(),
  relevantOccupation: z.union([s.OccupationSchema, z.array(s.OccupationSchema)]).optional(),
  responsibilities: z.union([z.string(), z.array(z.string())]).optional(),
  salaryCurrency: z.union([z.string(), z.array(z.string())]).optional(),
  securityClearanceRequirement: z.union([z.union([z.string(), z.string().url()]), z.array(z.union([z.string(), z.string().url()]))]).optional(),
  sensoryRequirement: z.union([z.union([s.DefinedTermSchema, z.string(), z.string().url()]), z.array(z.union([s.DefinedTermSchema, z.string(), z.string().url()]))]).optional(),
  skills: z.union([z.union([s.DefinedTermSchema, z.string()]), z.array(z.union([s.DefinedTermSchema, z.string()]))]).optional(),
  specialCommitments: z.union([z.string(), z.array(z.string())]).optional(),
  title: z.union([z.string(), z.array(z.string())]).optional(),
  totalJobOpenings: z.union([z.number().int(), z.array(z.number().int())]).optional(),
...
export const JointSchema: z.ZodType<Joint> = z.lazy(() => z.object({
  ...
  structuralClass: z.union([z.string(), z.array(z.string())]).optional(),
